...
export const draculaTheme: AppTheme = {
  ...
  colors: {
    primary: {
      ...
      accentColor: '#bd93f9',
      titleBarBg: '#1e1f29',
      titleBarSearchBg: '#282a36',
      titleBarSearchBorder: '#282a36',
      sideBarBg: '#343746',
...
export const ayuDarkTheme: AppTheme = {
  ...
  colors: {
    primary: {
      ...
      accentColor: '#e6b450',
      titleBarBg: '#1f2428',
      titleBarSearchBg: '#0a0e14',
      titleBarSearchBorder: '#0a0e14',
      sideBarBg: '#0a0e14',
...
export const ayuMirageTheme: AppTheme = {
  ...
  colors: {
    primary: {
      ...
      accentColor: '#e6b450',
      titleBarBg: '#1f2428',
      titleBarSearchBg: '#1f2430',
      titleBarSearchBorder: '#1f2430',
      sideBarBg: '#1f2430',
...
export const nordTheme: AppTheme = {
  ...
  colors: {
    primary: {
      ...
      accentColor: '#88c0d0',
      titleBarBg: '#1f2428',
      titleBarSearchBg: '#2e3440',
      titleBarSearchBorder: '#2e3440',
      sideBarBg: '#2e3440',
...
export const nightOwlTheme: AppTheme = {
  ...
  colors: {
    primary: {
      ...
      titleBarBg: '#011627',
      titleBarSearchBg: '#011627',
      titleBarSearchBorder: '#011627',
      sideBarBg: '#011627',
